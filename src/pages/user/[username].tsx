    ...
    <MainLayout>
                ...
                {followers.data?.followedBy.map((user) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      className=" flex items-center space-x-3 rounded px-4 py-2 transition"
                    >
            ...
            {isFollowModalOpen.modalType === "following" && (
              <div className="flex w-full flex-col justify-center">
                ...
                {following.data?.followings.map((user) => (
                  <div
                    key={user.id}
                    className="my-1 flex w-full items-center justify-between rounded-xl px-4 py-2"
                  >
                    <div>{user.name}</div>
                    <div>
                      <button
                        ...
                        className="flex items-center space-x-3 rounded border px-4 py-2 transition"
                      >
                        Unfollow
                      </button>
                    </div>
      ...
      <div className="flex h-full w-full items-center justify-center">
        <div className="my-10 flex h-full w-full flex-col items-center justify-center lg:max-w-screen-md xl:max-w-screen-lg">
          <div className="profileBanner flex w-full flex-col rounded-3xl shadow-md">
            <div className="relative h-44 w-full rounded-t-3xl bg-gradient-to-r from-blue-800 to-amber-500">
              <div className="absolute -bottom-10 left-12">
                <div className="group relative h-28 w-28 rounded-full border-2 border-blue-800 ">
            ...
            <div className="mt-10 ml-12 flex flex-col space-y-0.5 rounded-b-3xl py-4">
              ...
              <div className="text-blue-700">@{userProfile.data?.username}</div>
              ...
              <div className="flex w-full items-center space-x-4">
                <button
                  ...
                  className="writeTitleTwo invertButton mt-2 flex transform items-center space-x-3 rounded  px-4 py-2 transition active:scale-95 "
                >
                  <div>Share</div>
                  <div>
                    <SlShareAlt />
                ...
                {userProfile.isSuccess && userProfile.data?.followedBy && (
                  <button
                    ...
                    className="writeTitleTwo invertButton mt-2 flex items-center space-x-3 rounded px-4 py-2 transition "
                  >
                    {userProfile.data?.followedBy.length > 0
                      ? "Unfollow"
                      : "Follow"}
