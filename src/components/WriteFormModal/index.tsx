      ...
      >
          ...
          <>
            ...
            <div className="my-4 flex w-full items-center space-x-4">
              ...
              <button
                ...
                className="writeTitle invertButton space-x-3 whitespace-nowrap rounded border px-4 py-2 text-sm transition"
              >
                Create Tag
              </button>
            </div>
            <div className="my-4 flex w-full flex-wrap items-center">
              {selectedTags.map((tag) => (
                <div
                  key={tag.id}
                  className="m-2 flex items-center justify-center space-x-2 whitespace-nowrap rounded-2xl px-5 py-3"
                >
                  <div>{tag.name}</div>
                  <div
                    onClick={() =>
        ...
        >
          ...
          <input
            type="text"
            id="title"
            className="writeTitle h-full w-full rounded-xl border p-4 outline-none focus:border-yellow-600"
          ...
          <Controller
            ...
            control={control}
            render={({ field }) => (
              <div className="w-full writeParagraph">
                <ReactQuill
                  theme="snow"
                  {...field}
          ...
          <div className="flex w-full justify-end">
            <button
              type="submit"
              className="writeTitle invertButton flex items-center space-x-3 rounded border border-black px-4 py-2 transition"
            >
              Publish
            </button>
          </div>
