...
const SideSection = () => {
  ...
  return (
    <aside className="asideBox col-span-4 flex flex-col space-y-4 p-6">
      <div>
        <h3 className="my-6 text-lg font-semibold">
          More Interesting Users
        </h3>
        {/* suggestions */}
        <div className="moreUsers rounded  flex flex-col space-y-4">
          {suggestions.isSuccess &&
            suggestions.data.map((user) => (
              ...
              >
                <div className="h-10 w-10 flex-none rounded-full bg-yellow-600"></div>
                <div>
                ...
                <div>
                  <button
                    ...
                    className="writeTitle invertButton text-black flex items-center space-x-3 rounded  px-4 py-2 transition"
                  >
                    Follow
                  </button>
                </div>
